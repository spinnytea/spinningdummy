// stolen from http://tips4java.wordpress.com/2009/07/05/hsl-color/
...
public class HSLColor
{
	 ...
	 */
	public HSLColor(Color rgb, int alpha)
	{
		this(new Color(rgb.getRed(), rgb.getGreen(), rgb.getBlue(), alpha));
	}
	 ...
	 */
	public HSLColor adjustHueAbsolute(float degrees)
	{
		return new HSLColor(degrees, hsl[1], hsl[2], alpha);
	}

	/**
	 * Create a RGB Color object based on this HSLColor with a different
	 * Hue value. The degrees specified is an offset (added) value.
	 *
	 * @param degrees - the Hue value between 0 - 360
	 * @return the RGB Color object
	 */
	public HSLColor adjustHueOffset(float degrees)
	{
		return new HSLColor(hsl[0] + degrees, hsl[1], hsl[2], alpha);
	}
	...
	public HSLColor adjustShade(float percent)
	{
		...
		return new HSLColor(hsl[0], hsl[1], l, alpha);
	}
	...
	public HSLColor getComplementary()
	{
		...
		return new HSLColor(hue, hsl[1], hsl[2], alpha);
	}
