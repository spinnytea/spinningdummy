...
public class CountedSet<T> implements Set<T> {
	...
	public CountedSet() { map = new HashMap<T, Integer>(); total = 0; maxCount = 0; }
	public CountedSet(Collection<? extends T> aList) { this(); addAll(aList); }
	
	/** add an item to the set; this adds it with a count of 1 */
	@Override public boolean add(T t) { return this.add(t, 1); }
	...
	public boolean add(T t, int num) {
		if(t != null) {
			...
			map.put(t, num);
			if(maxCount >= 0 && maxCount < num) maxCount = num;
			return true;
		}
		return false;
	}
	...
	@Override public void clear() { map.clear(); total = 0; maxCount = 0; }
	@Override public boolean contains(Object o) { return map.get(o) != null; }
	@Override public boolean containsAll(Collection<?> c) { return map.keySet().containsAll(c); }
	...
	public boolean remove(Object o) {
		Integer i = map.get(o);
		if(i != null) total -= i;
		if(i != null && i == maxCount) maxCount = -1;
	...
	@Override public Object[] toArray() { return map.keySet().toArray(); }
	@Override public <E> E[] toArray(E[] a) { return map.keySet().toArray(a); }
	public ArrayList<T> toArrayList() { return new ArrayList<T>(map.keySet()); }
	...
	public CountedComparator getCountedComparator(boolean ascending) { return new CountedComparator(ascending); }
	 ...
	 * @author hendersontja
	 */
	public class CountedComparator implements Comparator<T> {
		private final boolean ascending;
		/** @param ascending if true, the first value will be low, if false, the first value will be high */
		private CountedComparator(boolean ascending) { this.ascending = ascending; }
	...
	public static class SerializableCountedSet<T extends Serializable> extends CountedSet<T> implements Serializable {
		private static final long serialVersionUID = -9034844083494946717L;
		public SerializableCountedSet() { super(); }
		public SerializableCountedSet(Collection<? extends T> aList) { super(aList); }
	}
}
