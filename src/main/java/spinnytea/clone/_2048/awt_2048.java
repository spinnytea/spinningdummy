...
public class awt_2048 extends JPanel implements view_2048 {
	...
	public awt_2048(_2048 game, boolean lookahead) {
		this.game = game;
	...
	public static JPanel mvc_2048() {
		...
		awt_2048 view = new awt_2048(model, false);
		key_2048 controller = new key_2048(model, view);
